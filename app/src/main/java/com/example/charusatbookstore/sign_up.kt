...
//sign up
        ...
        button4.setOnClickListener{
            ...
            when{
                ...
                TextUtils.isEmpty(password.text.toString())-> Toast.makeText(this,"Enter password",
                    Toast.LENGTH_LONG).show()
                TextUtils.isEmpty(username.text.toString())-> Toast.makeText(this,"Enter username",
                    Toast.LENGTH_LONG).show()
                TextUtils.isEmpty(name.text.toString())-> Toast.makeText(this,"Enter full name",
                    Toast.LENGTH_LONG).show()
                TextUtils.isEmpty(mobile_number.text.toString())-> Toast.makeText(this,"Enter mobile number",
                    Toast.LENGTH_LONG).show()
